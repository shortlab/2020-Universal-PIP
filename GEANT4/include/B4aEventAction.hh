...
class B4aEventAction : public G4UserEventAction
{
  public:
    ...
    void AddEdepDetectorBack(G4double edep) { eventTotEdepDetectorBack += edep; }
    void AddEdepDetectorFront(G4double edep) { eventTotEdepDetectorFront += edep; }


   private:
    G4double eventTotEdepDetectorBack;
    G4double eventTotEdepDetectorFront;
