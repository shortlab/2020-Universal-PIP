...
class B4DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    G4int material_num  = 0;

    void SetParameters(G4int sn);
    //G4String GetParameters() { return (G4UIcommand::ConvertToString(percentLowNum) + "_" + G4UIcommand::ConvertToString(numLayer)); }
