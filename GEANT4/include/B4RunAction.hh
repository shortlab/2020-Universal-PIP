...
class B4RunAction : public G4UserRunAction
{
  public:
    ...
    G4String filename = "";
    int implantation_x_histogram[4000] = {0};
    int implantation_y_histogram[4000] = {0};
    int implantation_z_histogram[4000] = {0};
    // note this is weird and the opposite of what you would expect, but it works so ...
    bool written = false;
  private:
